...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h3 class="rb-page-title mb-0">Create News / Event</h3>
        <small class="text-muted">Add a new post for the “News & Events” section.</small>
    </div>
        ...
        <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3 mt-1">
                ...
                <div class="col-md-6">
                    ...
                    <small class="text-muted">Recommended: 1000×700 (jpg/png/webp)</small>
                </div>
            </div>
